...
const styles = StyleSheet.create({
  ...
  paidStampText: { color: "#276A3A", fontSize: 9, fontFamily: "Helvetica-Bold" },
});
              ...
              {Number(invoice.amount_paid) > 0 && (
                <>
                  ...
                  <View style={styles.totalsRow}>
                    ...
                    <Text style={[styles.totalsValue, { fontFamily: "Helvetica-Bold", color: "#9A6800" }]}>{fmt(Number(invoice.balance_due))}</Text>
                  </View>
                </>
              )}
            </View>
